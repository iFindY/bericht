...
\section{Modularisierung} \label{sec:modularisierung}
  ...
  \subsection{Modularten}
    ...
    Um Reflection in einem Modul zu aktivieren, reicht es lediglich das ganze Modul als \textit{open module} oder mit Hilfe des \textit{opens package.name} Schlüssels ein spezielles Paket des Moduls in der \textit{module-info} zu deklarieren.  
