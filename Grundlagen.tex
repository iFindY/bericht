...
\section{Modularisierung} \label{sec:modularisierung}
  ...
  \subsection{Modularten}
    ...
    \newline Die \textit{automatischen Module} beschreiben einen Migrationsansatz der bestehenden Bibliotheken, die vom Klassenpfad auf den Modulpfad verschoben werden und keine \textit{Modulbeschreibung} besitzen. 
    ...
    Dies ist möglich und hilft den Entwickler Drittanbieter-Bibliothek in die Modularchitektur einzubinden, dennoch entsteht, durch den Import aller möglichen Module, eine starke Kopplung und somit eine unübersichtliche, starke Abhängigkeit zwischen den Modulen.
    \newline Das letzte Modul ist ein \textit{unbenanntes Modul}, dieser beschreibt alle Klassen, die sich parallel zu dem Modulpfad auf dem Klassenpfad befinden. 
