...
\bigbreak
 ...
 wann braucht man Reflexion 
Ihr Projektmanager verpflichtet sich zu einem Plug-In-Framework, das weiß, dass das System neue Komponenten akzeptieren muss, auch nachdem es erstellt und bereitgestellt wurde. Sie richten einige Schnittstellen ein und bereiten einen Mechanismus für das Patchen Ihrer JAR vor. Sie wissen jedoch, dass dies die Anforderungen an die Steckbarkeit nicht vollständig erfüllt.
...
Die drei Hauptmerkmale einer Klasse sind ihre Felder (Variablen), Methoden und Konstruktoren. Für die Beschreibung und den Zugriff auf ein Objekt werden diese drei Features in der Reflection-API durch separate Klassen dargestellt: java.lang.reflect.Field, java.lang.re flect.Method und java.lang.reflect.Constructor. Wir können diese Member einer Klasse über das Class-Objekt nachschlagen.
 ...
 % Beispiel: mit Methodenaufruf und Array als Übergabeparameter 
