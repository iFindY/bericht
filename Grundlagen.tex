...
\label{sec:modularisierung}
  ...
  \subsection{Modulstruktur}
    Die zuvor aufgeführten Ziele der Modularisierung liefern bereits eine Idee davon, was für Anforderungen Module erfüllen müssen, um von einem Modul sprechen zu können. Primär erfüllt ein Modul einen abgeschlossenen Aufgabenbereich und beinhaltet die dafür nötigen Operationen und Daten.
  ...
  % Moduldefenition
    \subsubsection{Moduldefinition}
      ...
      Korrektheit des Moduls durch Tests nachprüfbar ohne Kenntnis seiner Einbettung (Anmerkung: In der Praxis werden Module meist zu mockende Abhängigkeiten besitzen.) 
