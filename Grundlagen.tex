...
\section{Kapselung} \label{sub:Kapselung}
...
\section{Modularisierung} \label{sec:modularisierung}
  ...
  \subsection{Ziele der Modularisierung}
    ...
    \newline Um die Aufgabe des Java Modularisierung zu verstehen, bedarf es eine Aufstellung von Zielen und Qualitäten den sich die Modularisierung stellt. Für JPMS sind diese eindeutig in der \textit{JSR 376} beschrieben und spezifizieren die Folgenden Qualitäten.
  ...
  \subsection{Modulentwurfskriterien}
    ...
    Andernfalls kann durch eine starke Kopplung die Komplexität heben und Fehler begünstigen, indem der Umfang an Daten, die zwischen den Modulen ausgetauscht werden, erhöht wird. 
    Wenn Fehler nach einem Modulwechsel in der Verarbeitungskette auftreten, nennt man sie \textit{Seiteneffekte}. Diese entstehen wenn eine Aufgabe Modulübergreifend gelöst werden muss. Aus diesem Grund darf der Austausch einer Implementation durch eine andere \textit{Seiteneffektfrei} sein. 
