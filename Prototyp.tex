...
\section{Umsetzung}
 ...
 % projektstruktur anpassen
 	% was ist schief gelaufen, was habe ich über den Plan umsetzen müssen
 % gradle build script erstellen
 	% Was hat gradle besser als gedacht umgesetzt, wieos ist es toll "teaser"
 	% Verärbung
 	% Automatische bindung über Projektstruktur 
 % minimale Konfiguration Abhängigkeiten validieren
 	% Neue Komilation Abhängigkeiten  
