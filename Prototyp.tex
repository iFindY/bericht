...
\section{Mulan-Settler Renew Prototyp} \label{sec:mmulan_settler}
	Die Siedler oder Settler ist eine Aufbau-Strategiespiele, das mithilfe der Mulan (Multi-Agent Nets) Plattform aufgebaut und mit Renew simuliert werden kann. \bigbreak
...
\subsection{Kontext}
	...
	\end{figure}
	Das Spiel Settler ist mit Mulan umgesetzt und implementiert somit die Agenten Anforderungen des Multi Agenten System. Diese halten Wissensbasen über die Spielregeln und können mithilfe der Protokollnetze bestimmte Entscheidungen treffen und Handlungen ausführen. Wie zum Beispiel Straßen bauen oder Karten handeln.  
