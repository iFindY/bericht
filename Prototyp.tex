...
Die Siedler oder Settler ist eine Aufbau-Strategiespiele, dass mit Hilfe der Renew und der Mulan (Multi-Agent Nets) Plattform Simuliert werden kann. \bigbreak
...
\subsection{Spezifikation}
Für die Umsetzung des Prototyps muss die minimale Renew Version neu definiert und die benötigten zusätzlich Renew Plugins ausfindig gemacht werden. Zusätzlich muss das Settler Plugin auf die erforderliche Mulan Plugins analysiert werden, um diese der Laufzeitumgebung beizufügen und den Bedürfnissen bei Bedarf anzupassen. \newline
Da Mulan und Settler auf Renew aufbauen müssen die Änderungen nicht nur innerhalb der Mulan Plugins, sondern auch innerhalb ihrer \textit{Ant build scripte} angepasst werden, damit die Renew Klassen für das Kompilieren der internen Konstrukte gefunden und genutzt werden können. 
