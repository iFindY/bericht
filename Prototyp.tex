...
% Projektstruktur: tolle sache zusätzlich für da stesten kännten die testsrc sachen richtig eingegleiderst werden. 

% Projektstruktur: JavaCC aus allen Plugins in einem gemeinsamen Plugin zusammenfassen. Spagettii Code.  

% Gradle: Gewinnen von Versionsverwaltung und Platzs.

% Gradle: Trennen der Klassenpfade hilft die Struktur zu verwalten automatic, runtime, compile, api und implimentation. 
