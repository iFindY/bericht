...
% Petrinetze Forschungsstand 
Das Konzept der Petrinetze wurde in der Arbeit von \textit{Carl Petri} beschrieben. 
Dieses besteht aus Stellen, Marken, Kanten und Transitionen, die einen nebenläufigen kommunizierenden Prozess darstellen können. 
Der uhrsprüngliche \textit{S/∏T-Netz} Formalismus wurde mit der Zeit durch \textit{gefärbten Marken} erweitert, die äquivalente Strukturen zusammenfassen und die darin befindlichen Marken typesisren.
...
Dieses Anforderung  wird von den \textit{synchronen Kanälen} gelöst, indem die Netzkomponenten anstelle der Kanten mit synchronen Kanälen verbunden werden und zwingen die mit einader verbunden Transitionen synchron zu schalten.
...
Demzufolge wurde der nächste Evolutionschritt in der Entwicklung der Petrinetze mit den \textit{Referenznetz} Formalismus gemacht.
...
Die Entwicklu ng großen und verteilter Systemen führt zu komplexen Lösungen, die nur schwer zu verwalten sind.
