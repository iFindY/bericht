...
\section{Aufbau der Arbeit} \label{sec:AdA}
	...
	Das Ergebnis soll als Grundlage für den nächsten Lebenszyklus von \textsc{Renew} dienen und die Entwicklung einfach, flexibel und erweiterbar gestalten. Dafür wird die Unterstützung von \textsc{Mulan} benötigt, welches die wesentliche Funktion von \textsc{Renew} voraussetzt. 
