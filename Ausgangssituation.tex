	...
	\subsection{Plugin Charakteristika} \label{sub:plugin_beschriftung}
		...
		\begin{tabular}{l|l}
			...
			\\[-1em]
		     ...
		     \\[-1em]
		     Integrierte Services & Renew Services \\
		     \\[-1em]
		     Namen & Namen \\
		     \\[-1em]
		      & Beschreibung \\
