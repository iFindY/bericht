...
\section{Anforderungsspezifikation} 
	...
	Das Aufbereiten der Grundlagen sowie der Ausgangssituation sind essenzielle Schritte dieser Abschlussarbeit, da diese einen Vorher-Nachher-Vergleich ermöglichen und die wesentlichen Unterschiede sowie Gründe der Umsetzung zum Schein bringen. Zusätzlich leitet die Ausgangssituation von Renew das Migrationsszenario ein, das eine Beispielhafte Schritt für Schritt Migration demonstriert und auf der anderen Seite soll mithilfe des Mulan Rahmenwerks mögliche Probleme aufgedeckt werden, die beim Verbinden der bestehenden Systemen mit modularisierten Systemen auftreten. \bigbreak
