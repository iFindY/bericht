...
\section{Motivation}\label{sec:motivation}
	...
	- Die Modularisierung macht kein unterschied zwischen JDK und selbst geschriebenen Module, beide Modulklassen werden auf gleiche weise umgesetzt. 
	- Es ist möglich nur das Notwendige aus den Module auszuwählen und diese auf einem Rechner zu installieren.
	- Es ist nicht mehr notwendig den JDK mit der passenden Version auf der Maschine zu besitzen, denn die Module können mit den JDK Modulen kombiniert und als Laufzeit Bündel verpackt werden.
	- Dafür wird eine Konfiguration benötigt, die sich um die Verzahnung und Verwaltung der Module Kümmert. 
	- Diese Erstellt eine Komplette Ordner Struktur, die Lizenzinformation, Dokumentation Module und Startskript Besitzt. 
	- Da für die Anwendung keine Lokale Java Installation benötigt wird, muss die Applikation in sich Komplett sein  und die Konfiguration interen verwalten. 
	- Sicherheit der Anwendung muss auch intern geregelt werden 
	- Optimizierungs Potential 
	- Einfach auf Container und IoT Geräte  zu deployen 
...
#########
	...
	- maßgeschneiderten Laufzeit-Image die Module zusammen.
