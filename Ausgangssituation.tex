...
\section{Folgen} \label{sec:auswirkung}
	...
	% Der Plugin Manager % einer der aufgaben 
		...
		\subsubsection{Plugin Management mit Modulschichten}\label{ssub:plugin_managment_mit_modulschichten}
			...
			Im Folgenden wird eine Prototyp vorgestellt, der ein Plugin System simuliert, welches aus Modulen sowie  Modulschichten besteht und als ein Grundriss für die mögliche Umsetzung der nächsten \textsc{Renew} Version dienen könnte. \bigbreak
...
\newpage
	...
	\subsection{Plugin Manager }\label{sub:module_layer}
