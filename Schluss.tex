...
Um den endgültigen Austausch der \textit{plugin.cfg} durchführen zu können, muss der \textsc{Renew} Plugin Manager auf die neue Konfigurationsdatei angepasst werden. Dementsprechend ist die Auslesen der benötigten Information und die neu Implementation und Interpretation der Plugin Organisation ein zentrales Thema für die Übergang auf die \textit{module-inf.java}. Darüber hinaus ist das Konzept der Modulschichten eine anknüpfende Technik, die der Plugin Manager in der Zukunft in Betracht ziehen muss, um die Plugins sowie benötigten Drittanbieter-Bibliotheken auf die Schichten der Abhängigkeitskette entsprechend zu instanziieren. Obwohl die \textit{plugin.cfg} abgelöst werden kann, bleibt der Plugin Manger das Herzstück von \textsc{Renew} und muss sich an die neue Modulumgebung anpassen, um die Integration der neu eingeführten Java Features in \textsc{Renew} durchführen zu können.\bigbreak
