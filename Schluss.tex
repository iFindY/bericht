...
-> Eingene Libs die kustoimzed wurden sollen in das eingen gitlab eingechecht und geholtle werden köenn um diese nicht im repo zu haben 
-> Für die netze die mit der alten version umgesetzt worden sind köntnen man eine transofrimier funtkoin einbanuen,  die in den alten bildenrn die klassenreferenzen anpsst
-> ant Task die genutzt werden in groovy oder koltin umwnadlen um sich komplet von ant zu lösen


-> Größere Plugins (CH) (Formalsim) sollen auf module aufgeteilt werde
-> Plugins sollen ihre schnittstellenb bedacht angeben und müssten demenstrechend angepast werden ( jetzt wird das nötigste freigegeeben)

-> Den tollen Grundriss Prototpyne für den Nächsten Prototypen umsetzen
 

++kann zu einer strengeren Klassifizierung von Plugin-Systemen ausgebaut werden.
