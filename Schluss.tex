...
Ebenso wichtig ist die Verwaltung der Plugin Ressourcen, die von dem Modulsystem von Java gekapselt und für die Nutzung explizit in der \textit{module-info.java} geöffnet werden müssen. Diese Mechanik weist einen unerwarteten Effekt auf Plugins auf, die aufeinander aufbauen, ähnliche Paketenamen für die Ressourcengliederung belegen und diese global wiederverwenden. Die Umsetzung des Prototyps reorganisiert die Ressourcen und verlegt diese in dem \textit{META-INF} Verzeichnis, welches kein ausführbaren Code enthalten kann und in jedem Plugin existierend darf. Somit ist es eine gute wahl, um einen global einheitlichen Entwurf zu folgen. Die Umsetzung für die gestellte Anforderung benötigte mittleren Aufwand, da jedes Plugin eine eigene Vorgehensweise für das Laden implementiert und mit direkten String Konstellationen oder durch die Zusammensetzung der \textit{Path} Objekten arbeitet. \newline
