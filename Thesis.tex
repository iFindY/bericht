...
% Fazit
Die Modulsystem von Java reduziert die Komplexität von \textsc{Renew} und unterstützt damit die Wartbarkeit der langlebigen Plugin-Architektur. Darüber hinaus fördert das Modulsystem von Java das parallele und gemeinschaftliche Arbeiten an modularisierten Projekten, die in dem \textsc{Renew} Kontext eine wichtige Rolle spielen. Mit einem strukturierten Migrationskonzept, kann \textsc{Renew} in einer kontinuierlichen Prozess komplett auf das Modulsystem übertragen werden.  
\end{abstract}
