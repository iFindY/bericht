...
\bigbreak
% Stand
Es existieren bereits Arbeiten, die den Unifikationsverfahren von \textit{Renew} versuchen verteilt ausführen zu lassen. 
...
\bigbreak
% Aufbau
Im ersten Abschnitt diese Arbeit wird die Code Basis restrukturiert und gestaltet \textit{Renew} modular. 
