...
% \section{Modularisierung} \label{sec:modularisierung}
  ...
  \section{Modularten} \label{Modularten}
    ...
    Nichtsdestotrotz bieten die automatische und das unbenannt Modul diverse Migrationsszenarien, die flexible Wege für die Modernisierung der Applikation anbieten. 
