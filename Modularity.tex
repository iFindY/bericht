...
% \section{Modularisierung} \label{sec:modularisierung}
  ...
  % Moduleigenschaften 
  \subsection{Ziele der Modularisierung} \label{sec:ZdM}
  ...
  \subsection{Moduleigenschaften} \label{sec:ME}
...
\end{itemize}
  ...
  \subsection{Modulentwurfskriterien} \label{sec:MEK}
    % Einleitung
  ...
  \subsection{Modularten} \label{Modularten}
  ...
  \subsection{Module-Classloading} \label{sec:mod-cll}
