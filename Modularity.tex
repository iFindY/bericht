...
% \section{Modularisierung} \label{sec:modularisierung}
  ...
  \end{figure}
    ...
    Indem das Delegierungsmodell abgelöst wurde, werden andere Sicherheitsmaßnahmen für das Schützen der Kern Bibliotheken benötigt. Dies übernimmt jetzt das Modulsystem von Java, indem ein globales Verbot nach gleichnamiger Benennung von Paketstrukturen gilt. Somit verbietet Java zwei gleiche Bibliotheken auf demselben Modulpfad und garantiert einen eindeutigen Abhängigkeitsgraphen. \newline
...
\section{Das interne Modulsystem von Java} \label{sec:modular_java_base}
