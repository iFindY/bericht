...
\subsection{Gradle}
	...
	\begin{figure}[h!]
	  \centering
	  \includegraphics[width=0.4\textwidth]{material/images/ant-build.pdf}
	  \caption{Ant Skript}
	  \label{fig:antscript}
	\end{figure}
